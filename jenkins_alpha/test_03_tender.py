...
class ViewTenderPage(unittest.TestCase):
    """ 投资功能测试 """
    ...
    def test_money_empty(self):
        ...
        self.tender_page.input_verify_sms("0")
        result = self.tender_page.get_money_warn()
        try:
            self.assertEqual("请输入投标金额!",result)
            print("Test pass，test_money_empty")
        except Exception as e:
            self.tender_page.get_window_img()
            print("Test Fail, test_money_empty. ", format(e))
        finally:
            self.tender_page.to_tender() #进入投资理财页面
    ...
    def test_money_little(self):
        ...
        try:
            ...
            print("Test pass. test_money_little")
        except Exception as e:
            self.tender_page.get_window_img()
            print("Test Fail, test_money_little. ", format(e))
        finally:
            self.tender_page.to_tender() #进入投资理财页面
    
        
    def test_money_more(self):
        """ 投资-> 金额大于可投金额 """
        self.tender_page.select_tender_item() #选择标的
    ...
    def test_sms_wrong(self):
        """ 投资-> 验证码错误 """
        self.tender_page.select_tender_item() #选择标的
        self.tender_page.input_tender_money("100") #输入投资金额
        self.tender_page.get_tender_sms()# 点击获取验证码
        alert = self.tender_page.getAlertMsg()
        alert = self.tender_page.getAlertMsg()
    ...
    def test_coupons_cash_above(self):
        ...
        s_money = self.tender_page.get_tender_available() #获取剩余可投金额
        money = s_money.replace(",","")  # 替换字符串中的内容
        self.tender_page.input_tender_money(money) #输入投资金额
        self.tender_page.use_coupons_cash() #下拉列表中选择优惠券
        self.tender_page.get_tender_sms()# 获取验证码
        alert = self.tender_page.getAlertMsg()
        msg = self.tender_page.getAlertMsg()
        code=msg.split("：")[1]
        ...
        try:
            ...
            print("Test pass. test_coupons_cash_above")
        except Exception as e:
            self.tender_page.get_window_img()
            print("Test Fail, test_coupons_cash_above", format(e))
        finally:
            self.tender_page.to_tender() #进入投资理财页面
    ...
    def test_money_only(self):
        ...
        self.tender_page.input_verify_sms("")# 点击获取验证码
        ...
        try:
            ...
            print("Test pass，test_money_only")
        except Exception as e:
            self.tender_page.get_window_img()
            print("Test Fail, test_money_only", format(e))
        finally:
            self.tender_page.to_tender() #进入投资理财页面
    ...
    def test_with_coupons_cash(self):
        """ 投资-> 用代金券 """
        self.tender_page.select_tender_item() #选择标的
        self.tender_page.input_tender_money("500") #输入投资金额
        self.tender_page.use_coupons_cash() #下拉列表中选择优惠券
        self.tender_page.get_tender_sms()# 点击获取验证码
        alert = self.tender_page.getAlertMsg()
        msg = self.tender_page.getAlertMsg()
        ...
        try:
            self.assertIn("恭喜你投资成功",result)
            print("Test pass. test_with_coupons_cash")
        except Exception as e:
            self.tender_page.get_window_img()
            print("Test Fail, test_with_coupons_cash", format(e))
        finally:
            self.tender_page.to_tender() #进入投资理财页面 
    ...
    def test_with_coupons_rate(self):
        ...
        try:
            self.assertIn("恭喜你投资成功",result)
            print("Test pass. test_with_coupons_rate")
        except Exception as e:
            self.tender_page.get_window_img()
            print("Test Fail, test_with_coupons_rate", format(e))
        finally:
            self.tender_page.to_tender() #进入投资理财页面 
    ...
    def test_with_coupons_both(self):
        """ 投资-> 同时用两种劵 """
        self.tender_page.select_tender_item() #选择标的
        self.tender_page.input_tender_money("1310.55") #输入投资金额
        self.tender_page.use_coupons_cash() #下拉列表中选择优惠券
        self.tender_page.use_coupons_rate()# 使用加息券
        self.tender_page.get_tender_sms()# 点击获取验证码
        alert = self.tender_page.getAlertMsg()
        ...
        try:
            self.assertIn("恭喜你投资成功",result)
            print("Test pass. test_with_coupons_both")
        except Exception as e:
            self.tender_page.get_window_img()
            print("Test Fail, test_with_coupons_both", format(e))
        finally:
            self.tender_page.to_tender() #进入投资理财页面 
